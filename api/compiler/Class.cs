...
public class LanguageClass : Invocable {
    ...
    public LanguageClass(string name, Dictionary<string, LanguageParser.VarDclContext> props, Dictionary<string, ForeignFunction> methods)
    {
        Name = name;
        Props = props;
        Methods = methods;
    ...
    public ValueWrapper Invoke(List<ValueWrapper> args, CompilerVisitor visitor)
    {
       ...
       var constructor = GetMethod("constructor");
       if(constructor != null){
           return constructor.Bind(newInstance).Invoke(args, visitor);
       }
